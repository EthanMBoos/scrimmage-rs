...
#include <rq2-project/plugins/autonomy/FollowNearest/FollowNearest.h>
#include <limits>
...
REGISTER_PLUGIN(
    scrimmage::Autonomy,
    scrimmage::autonomy::FollowNearest,
    FollowNearest_plugin)

namespace scrimmage {
namespace autonomy {

void FollowNearest::init(std::map<std::string, std::string>& params) {
...
bool FollowNearest::step_autonomy(double t, double dt) {
