...
- [Your first autonomy plugin](tutorial/first-autonomy.md)
...
- [Plugin API and lifecycle](reference/plugin-api.md)
- [Built-in models](reference/models.md)
...
- [C++ reference guides](appendix/cpp.md)
  - [C++ architecture](appendix/cpp/architecture.md)
  - [C++ data flow](appendix/cpp/data-flow.md)
  - [C++ plugin development](appendix/cpp/plugin-development.md)
  - [C++ mission configuration](appendix/cpp/mission-config.md)
