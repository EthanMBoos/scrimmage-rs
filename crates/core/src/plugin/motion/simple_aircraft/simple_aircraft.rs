...
impl Plugin for SimpleAircraft {
    ...
    fn configure(params: &PluginParams<'_>) -> Result<AircraftConfig> {
        ...
        let config = AircraftConfig {
            ...
            max_roll_model_rad: crate::math::deg_to_rad(params.max_roll_deg),
            max_pitch_model_rad: crate::math::deg_to_rad(params.max_pitch_deg),
            max_roll_rate_model_radps: crate::math::deg_to_rad(params.max_roll_rate_degps),
            max_pitch_rate_model_radps: crate::math::deg_to_rad(params.max_pitch_rate_degps),
